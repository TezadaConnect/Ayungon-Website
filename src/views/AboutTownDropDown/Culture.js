	...
	return (
		<div className="w-screen">
			<div className="flex justify-center flex-col items-center w-screen ">
				...
				<div className="w-3/4 flex lg:flex-row flex-col justify-center pb-16 pt-5 gap-5">
					<div className="w-[550px] ">
						...
						<p className="font-serif text-justify text-lg pt-1">
					...
					<div className="w-[550px]">
						...
						<p className="font-serif text-justify text-lg pt-5">
						...
						<br></br>
						<h1 className="font-serif text-2xl font-bold pt-32">
