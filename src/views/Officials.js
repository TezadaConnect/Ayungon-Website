  ...
  return (
    <div>
      ...
      <div className="flex flex-col itme bg-slate-200 w-[1267px]  m-auto pb-36">
        <div className="flex flex-col  items-center bg-hero-pattern bg-cover bg-no-repeat drop-shadow-lg w-[1267px] h-[330px] lg:justify-start justify-center p-2 -z-0">
